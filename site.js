...
// Remove the validation and directly proceed to the report section after X-ray selection approval
document.getElementById("xray-approve-button").addEventListener("click", () => {
    // Proceed to the report section after X-ray selection without validation
...
// Remove the validation and directly proceed to the report section after Pathology selection approval
document.getElementById("path-approve-button").addEventListener("click", () => {
    // Proceed to the report section after Pathology selection without validation
